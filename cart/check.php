     ...
     foreach($_SESSION['cart'] as $stt => $soluong)
            {
               ...
               {
               echo '<meta http-equiv="refresh" content="10;index.php?content=cart">';
               echo "<h2> Sản phẩm <font color='red'><b>". $row['tensp']."</b></font> đã hết hoặc không đủ hàng trong kho<h2><br><br>";
               $loi+=1;
               }
            }
     if($loi==0)
